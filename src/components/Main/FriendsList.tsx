        ...
        <>
            <div className="w-80 h-full ml-auto px-4">
                <div className="flex justify-between items-center">
                    ...
                    <p className="text-sm text-neutral-300"><FaListUl /></p>
                </div>
                <div className="flex flex-col gap-2 py-2">
                    <div className="flex">
                        <div className="flex justify-center items-center w-14 h-14 pb-1 bg-white/5 rounded-xl border-1 border-white/10 shadow-lg shadow-black/20">
                            <div className="w-12 h-12 rounded-xl overflow-hidden">
                                <img className="mx-auto mt-1" src="https://starlightskins.lunareclipse.studio/render/dungeons/Zaaik/bust?borderHighlight=true&borderHighlightRadius=5" width={48} />
                            </div>
                        </div>
                    ...
                    <div className="flex">
                        <div className="flex justify-center items-center w-14 h-14 pb-1 bg-white/5 rounded-xl border-1 border-white/10 shadow-lg shadow-black/20">
                            <div className="w-12 h-12 rounded-xl overflow-hidden">
                                <img className="mx-auto mt-1" src="https://starlightskins.lunareclipse.studio/render/dungeons/wHenriqueLSH_/bust?borderHighlight=true&borderHighlightRadius=5" width={48} />
                            </div>
                        </div>
                        <div className="flex flex-col justify-center ml-2">
